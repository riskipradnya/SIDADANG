...
<style>
      /* Override sebelumnya (pertahankan dan sesuaikan nilainya jika perlu) */
      ...
      /* === COBA TAMBAHKAN INI SATU PER SATU SETELAH INSPEKSI === */

      /* Jika .main-panel yang punya padding/margin horizontal yang tidak diinginkan */
      
      /* .main-panel {
          padding-left: 0px !important;
          padding-right: 0px !important;
          margin-left: 0px !important; // Hati-hati, ini bisa merusak posisi jika ada sidebar fixed
          margin-right: 0px !important;
          width: 100% !important; // Jika lebarnya tidak penuh
          max-width: none !important; // Jika ada max-width yang membatasi
      } */
      ...
      /* Jika .container-scroller yang punya padding/margin horizontal */
/*       
      .container-scroller {
          padding-left: 0px !important;
          padding-right: 0px !important;
      ...
      */
      ...
      /* Jika body punya padding/margin horizontal (biasanya tidak, tapi CDN bisa saja mengubah) */
/*       
      body {
          padding-left: 0px !important;
          padding-right: 0px !important;
