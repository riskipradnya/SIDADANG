        ...
        <div class="row">
            <div class="col-md-6">
                ...
                $fields_kiri = [
                    ...
                    'nik'           => ['label' => 'NIK Penanggung Jawab', 'type' => 'text', 'name' => 'NIK', 'required' => true, 'pattern' => '\d{16}', 'title' => 'NIK harus 16 digit angka'],
                    'nama'          => ['label' => 'Nama Penanggung Jawab', 'type' => 'text', 'name' => 'Nama', 'required' => true],
